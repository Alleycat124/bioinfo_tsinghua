...
test@bioinfo_docker:~/linux$ cat 1.gtf | head -15
#!genome-build R64-1-1
#!genome-version R64-1-1
#!genome-date 2011-09
#!genome-build-accession :GCA_000146045.2
...
IV      ensembl CDS     1802    2950    .       +       0       gene_id "YDL248W"; gene_version "1"; transcript_id "YDL248W"; transcript_version "1"; exon_number "1"; gene_name "COS7"; gene_source "ensembl"; gene_biotype "protein_coding"; transcript_name "COS7"; transcript_source "ensembl"; transcript_biotype "protein_coding"; protein_id "YDL248W"; protein_version "1";
IV      ensembl start_codon     1802    1804    .       +       0       gene_id "YDL248W"; gene_version "1"; transcript_id "YDL248W"; transcript_version "1"; exon_number "1"; gene_name "COS7"; gene_source "ensembl"; gene_biotype "protein_coding"; transcript_name "COS7"; transcript_source "ensembl"; transcript_biotype "protein_coding";
test@bioinfo_docker:~/linux$ car 1.gtf | awk ' { print $1, $2, $3 } ' | head
...
CDS 1149
start_codon 3
test@bioinfo_docker:~/linux$ cat 1.gtf | awk 'BEGIN{size=0;}$3=="CDS"{len=$5-$4+1; size
+=len; print "Size:", size}' | tail -n 1
Size: 9030648
...
mean=1239.52
test@bioinfo_docker:~/linux$ cat 1.gtf | awk '$3=="gene"{split($10,x,";"); name=x[1];gs
ub("\"","",name); print name, $5-$4+1}' | head
YDL248W 1152
YDL247W-A 75
YDL247W 1830
YDL246C 1074
...
YDL241W 372
YDL240C-A 138
test@bioinfo_docker:~/linux$ cat 1.gtf | awk '$3=="gene"{split($10,x,";"); print $10, $
5-$4+1}' | head
"YDL248W"; 1152
"YDL247W-A"; 75
"YDL247W"; 1830
...
"YDL241W"; 372
"YDL240C-A"; 138
test@bioinfo_docker:~/linux$ cat 1.gtf | awk '$3=="gene"{split($10,x,";"); print $11, $
5-$4+1}' | head
gene_version 1152
gene_version 75
gene_version 1830
...
14730
14733
test@bioinfo_docker:~/linux$ cp 1.txt /home/test/share
